...
export const ASAAS_PLANS = {
  monthly: {
    ...
    pro: {
      ...
      slug: 'placeholder_pro_mensal',
      checkoutUrl: 'https://www.asaas.com/c/PLACEHOLDER_PRO_MENSAL',
      docLimit: 500,
      trialDocs: 10,
      cnpjsLimit: 2,
      bankAccountsLimit: 2,
    ...
    super: {
      ...
      slug: 'placeholder_super_mensal',
      checkoutUrl: 'https://www.asaas.com/c/PLACEHOLDER_SUPER_MENSAL',
      docLimit: 1000,
      trialDocs: 50,
      cnpjsLimit: 4,
      bankAccountsLimit: 4,
  ...
  annual: {
    ...
    pro: {
      ...
      slug: 'placeholder_pro_anual',
      checkoutUrl: 'https://www.asaas.com/c/PLACEHOLDER_PRO_ANUAL',
      docLimit: 500,
      trialDocs: 10,
      cnpjsLimit: 2,
      bankAccountsLimit: 2,
    ...
    super: {
      ...
      slug: 'placeholder_super_anual',
      checkoutUrl: 'https://www.asaas.com/c/PLACEHOLDER_SUPER_ANUAL',
      docLimit: 1000,
      trialDocs: 50,
      cnpjsLimit: 4,
      bankAccountsLimit: 4,
...
export const ASAAS_ONE_OFF = {
  ...
  dreConsolidatedMultiCnpj: {
    ...
    checkoutUrl: 'https://www.asaas.com/c/PLACEHOLDER_DRE_AGRUPADO',
    slug: 'placeholder_dre_agrupado',
  },
  bankReconciliationExtra: {
    ...
    checkoutUrl: 'https://www.asaas.com/c/PLACEHOLDER_CONCILIACAO_EXTRA',
    slug: 'placeholder_conciliacao_extra',
  },
} as const;
